...
* **Distance:**
  * The target must have the user's blood if not in line of sight
  * **No line of sight, but same territory:** +1 DC
  * **Sect territory <--> Neutral territory**: +2 DC
  * **Camarilla territory <--> Anarch territory:** +3 DC
  * **Outside the city: +4 DC**
...
### Blood Sorcery - _Illuminate the Trail of Prey_
...
Characters who take the No Haven flaw must find a place to sleep by the end of the IC night. This will require either an Intelligence/Wits + Survival roll, usually at a difficulty of 3. Failing at this roll inflicts one level of aggravated damage per point of missed margin (though you will find shelter eventually). Obviously, if your character finds someone willing to provide shelter, you need not make this roll.
...
After character creation, the Status background will be awarded purely on merit and will not cost exp to keep. Note, however, that Status is easier to lose than it is to obtain.

### Torpor

When ending torpor early by drinking higher-BP vitae, a character with a health tracker full of aggravated damage reduces one level of damage to superficial.
