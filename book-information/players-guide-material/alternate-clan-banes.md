---
description: >-
  Though many of the new banes are interesting, we wanted to be as
  non-disruptive as possible. Therefore, we only replaced those banes that never
  or rarely impact play.
---

# Alternate Clan Banes

## Adopting

We are adopting the following banes from the _Players Guide_, which will **replace the original banes**. Because not everyone has the book, we've reproduced the bane text below.
